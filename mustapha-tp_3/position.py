...
if __name__ == '__main__':
    ...
    assert position.positions_diagonales_bas() == [Position(6, 3), Position(6, 5)]
    assert position.positions_diagonales_haut() == [Position(4, 3), Position(4, 5)]
    assert position.quatre_positions_diagonales() == [Position(4, 3), Position(4, 5), Position(6, 3), Position(6, 5)]
    assert position.quatre_positions_sauts() ==  [Position(3, 2), Position(3, 6), Position(7, 2), Position(7, 6)]
